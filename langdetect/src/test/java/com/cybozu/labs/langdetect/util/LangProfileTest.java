...
public class LangProfileTest {
    ...
    public final void testAddIllegally1() {
        final LangProfile profile = new LangProfile(); // Illegal ( available for only JSONIC ) but ignore
        profile.add("a"); // ignore
        assertEquals(profile.freq
                            .get("a"), null); // ignored
    }
